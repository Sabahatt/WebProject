  ...
  return (
    <div className={"w-screen h-screen fixed top-0 left-0 z-30 flex "+visibleClass} style={{backgroundColor:'rgba(0,0,0,.6)'}}>
      <ClickOutHandler onClickOut={() => modalContext.setShow(false)}>
        <div style={{backgroundColor:'white'}} className="border border-reddit_light-brightest w-3/4 sm:w-1/2 lg:w-1/4 bg-reddit_light p-5 text-reddit_text self-center mx-auto rounded-md">
          {modalType === 'login' && (

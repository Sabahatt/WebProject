  ...
  return (
    <div
      ...
      <ClickOutHandler onClickOut={() => {}  }>
        <div style={{backgroundColor:'white'}} className="border border-reddit_light-brightest w-3/4 md:w-2/4 bg-reddit_light p-5 text-reddit_text self-center mx-auto rounded-md">
